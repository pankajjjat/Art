// ===== MITTI (मिट्टी) — Product Catalog (13 core products) =====
...
const products = [
  // ============ LANDSCAPES (4) ============
  {
    ...
    featured: true, dimensions: '30" × 40"'
  },
  {
    ...
    featured: false, dimensions: '24" × 36"'
  },
  {
    ...
    featured: true, dimensions: '28" × 36"'
  },
  {
    ...
    featured: false, dimensions: '20" × 28"'
  },
  ...
  // ============ ABSTRACT (4) ============
  {
    ...
    featured: false, dimensions: '18" × 24"'
  },
  {
    ...
    featured: true, dimensions: '24" × 30"'
  },
  {
    ...
    featured: false, dimensions: '28" × 36"'
  },
  {
    ...
    featured: true, dimensions: '36" × 48"'
  },
  ...
  // ============ LIPPAN ART (2) ============
  {
    ...
    featured: true, dimensions: '18" × 18"'
  },
  {
    ...
    featured: false, dimensions: '24" × 24"'
  },
...
// Categories metadata (updated counts for 13 products)
const categories = [
  { id: "landscapes", name: "Landscapes", count: 4, image: "images/optimized/landscapes_1.jpg" },
  { id: "abstract", name: "Abstract", count: 4, image: "images/optimized/abstract_11.jpg" },
